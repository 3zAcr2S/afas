...
else
{
    ...
    actuator[0] = rp_scale * P_plus + rp_scale * R_minus- yaw_thrust;
    // right servo
    actuator[1] = -rp_scale * P_plus + rp_scale * R_plus - yaw_thrust;
    // rear servo
    actuator[2] = -rp_scale * P_minus - rp_scale * R_plus - yaw_thrust;
    // left servo
    actuator[3] = rp_scale * P_minus - rp_scale * R_minus - yaw_thrust;
